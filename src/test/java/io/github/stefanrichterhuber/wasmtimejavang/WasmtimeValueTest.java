...
public class WasmtimeValueTest {
    ...
    public void testWatF32Test() throws Exception {
        try (
            ...
            linker.linkFunction("env", "imported_func", List.of(ValType.F32), List.of(ValType.F32),
                    (instance, params) -> {
    ...
    public void testWatF64Test() throws Exception {
        ...
        try (
            ...
            store.getContext().put("greeting", "Hello world");
            linker.linkFunction("env", "imported_func", List.of(ValType.F64), List.of(ValType.F64),
                    (instance, params) -> {
    ...
    public void testWatI32Test() throws Exception {
        ...
        try (
            ...
            store.getContext().put("greeting", "Hello world");
            linker.linkFunction("env", "imported_func", List.of(ValType.I32), List.of(ValType.I32),
                    (instance, params) -> {
                        int p = (int) params[0];
                        int r = p * 3;
                        return new Object[] { r };
    ...
    public void testWatI64Test() throws Exception {
        ...
        try (
            ...
            store.getContext().put("greeting", "Hello world");
            linker.linkFunction("env", "imported_func", List.of(ValType.I64), List.of(ValType.I64),
                    (instance, params) -> {
    ...
    public void testWatFuncRefTest() throws Exception {
        ...
        try (
            ...
            store.getContext().put("greeting", "Hello world");
            linker.linkFunction("env", "imported_func", List.of(), List.of(),
                    (instance, params) -> {
                        return new Object[] {};
                    });
    ...
    public void testWatExternRefTest() throws Exception {
        ...
        try (
            ...
            store.getContext().put("greeting", "Hello world");
            linker.linkFunction("env", "imported_func", List.of(ValType.Ref), List.of(),
                    (instance, params) -> {
