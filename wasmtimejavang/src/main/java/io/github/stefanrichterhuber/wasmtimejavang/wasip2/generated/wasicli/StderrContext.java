...
/**
 * Generated from WIT interface "wasi:cli/stderr" by wit-codegen-maven-plugin.
 ...
 */
public interface StderrContext extends WasmComponentContext {
    String INTERFACE = "wasi:cli/stderr";
    ...
    default List<ComponentImportFunction> getImportFunctions() {
        return List.of(
                new ComponentImportFunction(versioned(), "get-stderr", this::stderrGetStderrImpl)
            );
    }
    ...
    WitResource stderrGetStderr(WasmtimeComponentInstance instance);

    void dropOutputStream(int rep);

    private Object[] stderrGetStderrImpl(WasmtimeComponentInstance instance, Object... args) {
        return new Object[] { stderrGetStderr(instance) };
    }
